package com.example.ticketmachinemobile.ui.theme
 ...
 */
@Composable
fun TicketMachineMobileTheme(content: @Composable () -> Unit) {
 ...
 */
@Composable
fun TicketMobileDialogThemeOverlay(content: @Composable () -> Unit) {
